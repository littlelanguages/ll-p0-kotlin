package io.littlelanguage.p0.bin
...
import io.littlelanguage.p0.dynamic.translate
import io.littlelanguage.p0.lexer.LA
import io.littlelanguage.p0.lexer.assembleTokens
import io.littlelanguage.p0.semantic.compile
...
private fun astOnly(input: Input) {
    val ast =
            io.littlelanguage.p0.static.parse(LA(StringReader(input.src.readText())))
